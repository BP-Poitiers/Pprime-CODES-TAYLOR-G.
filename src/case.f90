...
contains
  ...
  subroutine init (rho1, ux1, uy1, uz1, ep1, phi1, drho1, dux1, duy1, duz1, dphi1, &
    ...
    elseif (itype.eq.itype_strat) then

       call init_strat(ux1, uy1, uz1, ep1, phi1)

    elseif (itype.eq.itype_strat_II) then
       call init_strat_II(ux1, uy1, uz1, ep1, phi1)
  ...
  subroutine boundary_conditions (rho,ux,uy,uz,phi,ep)
    ...
    elseif (itype.eq.itype_strat) then
       ...
       call boundary_conditions_strat(ux, uy, uz, phi)

    elseif (itype.eq.itype_strat_II) then
       call boundary_conditions_strat_II(ux, uy, uz, phi)
  ...
  subroutine postprocess_case(rho,ux,uy,uz,pp,phi,ep)
    ...
    elseif (itype.eq.itype_strat) then
       ...
       call postprocess_strat(ux, uy, uz, phi)

    elseif (itype.eq.itype_strat_II) then
       call postprocess_strat_II(ux, uy, uz, phi)
  ...
  subroutine scalar_forcing(dphi1, rho1, ux1, uy1, uz1, phi1)
    ...
    elseif (itype.eq.itype_strat) then
       ...
       call scalar_forcing_strat(uy1, dphi1, phi1)

    elseif (itype.eq.itype_strat_II) then
       call scalar_forcing_strat_II(uy1, dphi1, phi1)
