...
! WORK IN PROGRESS - JE FAIS DE MON MIEUX POUR TROUVER DU TEMPS SUR CE CODE

module stratified_II
   ...
   public :: init_strat_II, boundary_conditions_strat_II, postprocess_strat_II, scalar_forcing_strat_II, inflow_strat_II, outflow_strat_II
...
contains
   ...
   !!
   !############################################################################
   subroutine init_strat_II(ux1, uy1, uz1, ep1, phi1)
   ...
   end subroutine init_strat_II

   !!----------------------------------------------------------------------------
   !! Boundary conditions for the stratified case
   !!----------------------------------------------------------------------------
 
   subroutine boundary_conditions_strat_II(ux, uy, uz, phi)
      ...
      END IF
      IF (nclyn == 2) THEN
              call inflow_strat_II(ux,uy,uz,phi)
      END IF
      IF (nclz1 == 2) THEN
      END IF
      IF (nclzn == 2) THEN
   ...
   end subroutine boundary_conditions_strat_II

   !!--------------------------------------------------------------------------------------
   !! Inflow in y=Ly - displacement
   !!-------------------------------------------------------------------------------------

   subroutine inflow_strat_II (ux,uy,uz,phi)
   ...
   end subroutine inflow_strat_II


  !*******************************************************************************
  !
   subroutine scalar_forcing_strat_II(uy1,dphi1,phi1)
  !
  !*******************************************************************************
   ...
   end subroutine scalar_forcing_strat_II
   ...
   subroutine outflow_strat_II (ux,uy,uz,phi)
   ...
   end subroutine outflow_strat_II
   ...
   !!
   !############################################################################
   subroutine postprocess_strat_II(ux1, uy1, uz1, phi1)
   ...
   end subroutine postprocess_strat_II

end module stratified_II
