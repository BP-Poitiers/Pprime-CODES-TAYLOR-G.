...
program xcompact3d
  ...
  do itime=ifirst,ilast
     ...
     do itr=1,iadvance_time
       ...
       !      print*, "Apres Transeq", uy1(100, xsize(2), 1)
       !      print*, "----------"
       ! end if
        ...
        !if (mod(itime, 100).eq.0) then
        !     print*, "Apres int_time", uy1(100, xsize(2), 1)
        !     print*, "----------"
        !end if
        ...
        !     print*, "-----------------------------"
        !     print*, "amplitude", ampli_sin
        !     print*, "pulsation", pulse_sin
        !     print*, "sin :", sin(itime*dt)
        !     print*, "b_c :", uy1(100, xsize(2), 1)
        !     print*, "-----------------------------"
        !end if
        ...
        !if (mod(itime, 100).eq.0) then
        !     print*, "Apres Cor_vel", uy1(100, xsize(2), 1)
        !     print*, "----------"
        !end if
    ...
    ! if (mod(itime, 100).eq.0) then
    !         print*, "Apres restart", uy1(100, xsize(2), 1)
    ! end if
